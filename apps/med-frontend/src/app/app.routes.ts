...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'dashboard', component: Dashboard },
      {
        ...
        loadChildren: () => import('./routes/pacientes/pacientes.routes').then(m => m.routes),
      },
      { 
        path: 'exames', 
        data: { title: 'Exames' },
        loadChildren: () => import('./routes/exames/exames.routes').then(m => m.routes) },
  ...
  { path: '**', redirectTo: 'pacientes/listarPacientes' },
];
